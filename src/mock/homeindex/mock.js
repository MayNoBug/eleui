...
let data = [
    {id:0,name:"路飞",text:"要成为海贼王的男人"},
        {id:1,name:"索隆",text:"要成为天下第一大剑豪"},
        {id:2,name:"乌索普",text:"要成为伟大的冒险家"},
        {id:3,name:"娜美",text:"要成为最伟大的航海士"},
        {id:4,name:"乔巴",text:"是特殊时期的应急粮食"},
        {id:5,name:"山治",text:"毕生梦想隐身果实"},
        {id:6,name:"弗兰奇",text:"最变态的变态"},
        {id:7,name:"罗宾",text:"收齐被掩盖的历史正文"},
        {id:8,name:"布鲁克",text:"可以看看你的胖次吗"},
        {id:9,name:"甚平",text:"鱼人空手道"},
